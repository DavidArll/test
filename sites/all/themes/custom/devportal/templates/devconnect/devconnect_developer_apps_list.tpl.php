  ...
  <div class="row">
    <div class="col-sm-12">
      <div class="add-app-button pull-right">
        <a href="#" id="getHelp" class="btn btn-primary btn-alt"><i class="fa fa-play-circle"></i> Need help?</a>
        <?php print $add_app; ?>
      </div>
    </div>
  </div>
  ...
  <?php foreach ($applications as $app): ?>
        ...
        <div class="panel-heading">
          <h4 class="panel-title">
            <div class="truncate">
              ...
              <a class="panel-link" data-toggle="collapse" data-parent="#my-apps-accordion" href="#my-apps-collapse<?php print $i; ?>"><strong><?php print check_plain($app['app_name']); ?></strong></a>
            </div>
    ...
    <?php endif; ?>
            <div class="tab-content" id="myTabContent">
              <div id="keys<?php print $i; ?>" class="keys-panel tab-pane fade in active">
                <hr>
                <div class="panel panel-default">
