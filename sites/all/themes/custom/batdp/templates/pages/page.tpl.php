    ...
    <div class="navbar-header">
      <?php if ($logo): ?>
        <a class="logo navbar-btn pull-left" href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>">
          <div class="logo-pg">
            <img src="<?php echo $theme_path . '/logo.png'; ?>" alt="<?php print $site_name; ?>" height="43" width="80" />
            <img src="<?php echo $theme_path . '/logo2.png'; ?>" class="logo2" alt="<?php print $site_name; ?>" height="41" width="80" />
          </div>            
        </a>
      <?php endif; ?>
