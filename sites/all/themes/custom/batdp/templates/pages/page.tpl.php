    ...
    <div class="navbar-header">
      <?php if ($logo): ?>
        <a class="logo navbar-btn pull-left" href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>">
          <div class="logo-pg">
            <img src="<?php echo $theme_path . '/logo.png'; ?>" alt="<?php print $site_name; ?>" height="45" width="59" />
            <img src="<?php echo $theme_path . '/logo2.png'; ?>" alt="<?php print $site_name; ?>" height="42" width="59" />
          </div>            
        </a>
      <?php endif; ?>
  ...
  <div class="container">
    <div class="navbar-header">
      <?php if ($logo): ?>
        <a class="logo navbar-btn pull-left" href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>">
          <div class="logo-pg">
            <img src="<?php echo $theme_path . '/logo.png'; ?>" alt="<?php print $site_name; ?>" height="40" width="65" />
          </div>
        </a>
      <?php endif; ?>
        ...
        <nav role="navigation">
          ...
          <ul class="menu nav navbar-nav pull-right account-menu"  >
            ...
            <?php else: ?>
              <li class="first expanded dropdown" data-step="1" data-intro="Make sure you're logged in with the correct credentials.">
                <a data-toggle="dropdown" class="dropdown-toggle" data-target="#" title="" href="/user">
                  <i class="icon-user"></i> <span class="username"><?php print $user_mail_clipped; ?></span> <span class="caret"></span>
                </a>
                <ul class="dropdown-menu"><?php print $dropdown_links; ?></ul>
              </li>
